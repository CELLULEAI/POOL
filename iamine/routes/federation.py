...
# ─── Phase 2 Console Molecule : /v1/federation/admin/* ──────────────────────
#
# Cross-pool admin actions with manual approve/reject on target side.
# 2 whitelisted actions : circuit_reset, query_events.
#
# Security invariants (guardians 2026-04-15) :
#   - trust>=3 STRICT (replication-bonded minimum)
#   - Opt-in pool_config.federation_admin_actions_enabled (off by default)
#   - Ed25519 envelope signature = sole authority (X-IAMINE-Admin-Email = display)
#   - circuit_reset blocked if slashing_events pending (explicit override logged)
#   - Cooldown + max_pending anti-abuse
